...
import salePic from "./sale.jpg";

import { RiFacebookBoxFill, RiInstagramFill } from "react-icons/ri";
import "./supplier-profile-drawer-module.css";
import { useDispatch } from "react-redux";
import { getSupplierByIdService } from "../../services/public-api-service";
...
const SupplierProfileBanner = ({ data }) => {
  return (
...
const SupplierProfileDetails = ({ data }) => {
  return (
    <Row gutter={16} style={{ height: "max-content" }}>
      ...
      <Col span={12}>
        <div className="w-100 p-3 h-100" style={{ ...styles.parent }}>
          ...
          <Text>
            <b>Firstname : </b>
            {data.supplierFirstname}
          </Text>
          <br />
          <Text>
            <b>Lastname : </b>
            {data.supplierLastname}
          </Text>
          <br />
          <Text>
            <b>Phone no # </b>
          ...
          <Space direction="horizontal" className="my-2">
            <a
              target={"_top"}
              href={data.instagram !== null && data.instagram.instagram_url}
            >
              <RiInstagramFill
                size={20}
                fill="#C13584"
...
const SupplierProfileAboutMe = ({ data }) => {
...
const SupplierProfileProducts = ({ data }) => {
...
function SupplierProfileDrawer({
  ...
  useEffect(() => {
    ...
    dispatch(
      getSupplierByIdService({ supplierId, hooks: { setData, setisLoading } })
    );
  }, [dispatch, setData, setisLoading, supplierId]);
  ...
  return (
    ...
    >
      {isLoading.state === "loading" ? (
        ...
        <>
          <SupplierProfileBanner data={data} />
          <SupplierProfileDetails data={data} />
          <SupplierProfileAboutMe data={data} />
          <SupplierProfileProducts data={data} />
        </>
      )}
    </Drawer>
  );
